...
const Projects = () => {
  ...
  return (
    <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:1.5}} className='h-screen relative flex overflow-hidden flex-row text-left max-w-full mx-auto z-40 justify-center items-center '>
        <h3 className='absolute top-20 uppercase tracking-[20px] text-gray-500 text-2xl'>Projects</h3>

        <div className='relative w-full overflow-x-scroll snap-x snap-mandatory flex z-40 scrollbar scrollbar-track-gray-500/20 scrollbar-thumb-[#f7ab0a]/20' >
        ...
        <div className='w-full absolute top-[30%] bg-[#f7ab0a]/10 h-[250px] md:h-[400px] left-0 skew-y-3  '></div>
    </motion.div>
  );
}
